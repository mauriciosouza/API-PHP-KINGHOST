...
class Dominio extends Kinghost
{
	// getDominios() {{{
	/**
	* Retorna todos os dominios de sua conta ou de um cliente se passado o parâmetro $idCliente
	* 
	* Example:
	* <code>
	...
	* require_once 'Dominio.php';
	* $adsl = new Dominio('meu@email.com' , '123456');
	* print_r($adsl->getStatusSSH($idDominio));
	* </code>
	*
	* @access public
	* @return object
	*/		
	...
	// getDadosDominio() {{{
	/**
	* Retorna os dados de um dominio, informar o $idDominio
	* 
	* Example:
	* <code>
	* require_once 'Dominio.php';
	* $adsl = new Dominio('meu@email.com' , '123456');
	* print_r($adsl->getDadosDominio($idDominio));
	* </code>
	*
	* @access public
	* @return object
